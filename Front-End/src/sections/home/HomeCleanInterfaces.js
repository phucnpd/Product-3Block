...
const IMG = [...Array(10)].map(
  (_, index) => `https://votuenam.github.io/image-hosting/CleanInterface/clean-${index + 1}.png`
);
          ...
          {IMG.map((_, index) => (
            ...
            >
              <Image
                ...
                visibleByDefault
                alt={`clean-${index + 1}`}
                src={`https://votuenam.github.io/image-hosting/CleanInterface/clean-${isLight ? 'light' : 'dark'}-${
                  index + 1
                }.png`}
              />
            </MotionInView>
