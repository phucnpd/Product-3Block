...
export const description = [
  'Yes. Your proposal will be reviewed by us based on our criteria.',
  'No. We only allow users to view common URLs on the system.',
  'Thank you for your question, on the service side, we promise that our service is completely free.',
  'Yes. With games that run directly on the web browser, our service can completely block these websites.',
  'Our search box at Home page or Dashboard page (logged in users). You fill the URL here and press Enter. Results will be displayed shortly!!!.',
  'Depending on each URL, the results that may be displayed include: Malware, Phishing, Spam, Ransomware, Clean, Unrated...',
  'Updating...',
  'You can search and download the "3Block" keyword extension at the Chrome Store.',
