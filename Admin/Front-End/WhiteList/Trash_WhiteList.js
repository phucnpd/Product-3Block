...
function destroy(urldestroy) {
    //API Real Delete
    fetch(
        "https://admin3blockapi.herokuapp.com/db/api/system/3block/realDeleteWhite",
        {
            method: "DELETE",
            headers: {
...
function restore(urlrestore) {
    //API Restore
    fetch(
        "https://admin3blockapi.herokuapp.com/db/api/system/3block/restoreWhite",
        {
            method: "PATCH",
            headers: {
                "Content-Type": "application/json",
...
function refresh() {
    ...
    //API Trash WhiteList
    fetch(
        "https://admin3blockapi.herokuapp.com/db/api/system/3block/getWhiteTrash",
        {
            method: "GET",
            headers: {
                "Content-Type": "application/json",
