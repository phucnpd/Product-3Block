...
function show(number) {
    ...
    fetch(
        "https://admin3blockapi.herokuapp.com/api/3block/system/getNotFound18",
        {
            method: "GET",
            headers: {
...
function deleted(urldestroy) {
    ...
    if (result) {
        fetch(
            "https://admin3blockapi.herokuapp.com/api/3block/system/deleteNotFound18",
            {
                method: "DELETE",
                headers: { "Content-Type": "application/json" },
                body: JSON.stringify({
